...
export delimited using "$output_dir/$datetime/metadata/var-names.csv", delim(";") replace
...
export delimited using "$output_dir/$datetime/metadata/var-types.csv", delim(";") replace
label data "Generated by export-metadata-other.do"
...
export delimited using "$output_dir/$datetime/metadata/var-pops.csv", delim(";") replace
label data "Generated by export-metadata-other.do"
...
export delimited using "$output_dir/$datetime/metadata/var-ages.csv", delim(";") replace
label data "Generated by export-metadata-other.do"
